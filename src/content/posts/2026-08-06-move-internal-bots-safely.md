...
problem: "작은 장비에서 돌던 내부 봇을 안정적으로 운영하면서도 외부 노출과 사람의 직접 접근을 줄여야 했다."
decision: "아웃바운드 연결, 중앙 권한 관리, 분리된 네트워크 구역을 기준으로 기존 클라우드 환경을 재사용했다."
outcome: "공개 진입점을 늘리지 않으면서 접근 기록과 자원 격리를 갖춘 운영 구조를 정했다."
draft: false
---
